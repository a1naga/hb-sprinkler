...
public class Schedule extends JPanel {
	...
	public Schedule(String selectedId, boolean isSprinkler) {
		...
		m1.setIcon(new ImageIcon(getClass().getResource("/res/deleteIcon.png")));
		m1.setPreferredSize(new Dimension(55, 20));
		m1.setActionCommand("m1");
		JMenuItem m2 = new JMenuItem("*");
		m2.setIcon(new ImageIcon(getClass().getResource("/res/deleteIcon.png")));
		m2.setPreferredSize(new Dimension(55, 20));
		m2.setActionCommand("m2");
		JPanel p1=new JPanel();
		p1.add(new JLabel("5 - 7"));
		p1.add(m1);
		JPanel p2=new JPanel();
		p2.add(new JLabel("9 - 10"));
		p2.add(m2);
	...
	private void populateInnerPanes()
	{
		...
		else//else if group selected,
		{
			...
			int groupId=sg.getSprinklerGroupByName(selectedId).getGroupId();
